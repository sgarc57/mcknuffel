...
export const products = [
  ...
  { id: 3, name: 'Monster Fruit', description: 'I really wanted a squishy but i the other ones where sold out so mom bought me this', category: 'weird', image: greenTrex },
];
